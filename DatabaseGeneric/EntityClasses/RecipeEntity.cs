...
namespace RecipeORM.RelationClasses
{
	...
	public partial class RecipeRelations: RelationFactory
	{
		...
		/// <summary>Returns a new IEntityRelation object, between RecipeEntity and RecipeCategoryDictionaryEntity over the 1:n relation they have, using the relation between the fields: Recipe.Id - RecipeCategoryDictionary.RecipeId</summary>
		public virtual IEntityRelation RecipeCategoryDictionaryEntityUsingRecipeId
		{
			get { return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.OneToMany, "RecipeCategoryDictionaries", true, new[] { RecipeFields.Id, RecipeCategoryDictionaryFields.RecipeId }); }
		}
	...
	internal static class StaticRecipeRelations
	{
		...
		internal static readonly IEntityRelation RecipeCategoryDictionaryEntityUsingRecipeIdStatic = new RecipeRelations().RecipeCategoryDictionaryEntityUsingRecipeId;
