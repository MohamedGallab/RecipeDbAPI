...
namespace RecipeORM.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting IngredientEntity instances in the database.</summary>
		public DataSource2<IngredientEntity> Ingredient {	get { return new DataSource2<IngredientEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting InstructionEntity instances in the database.</summary>
		public DataSource2<InstructionEntity> Instruction {	get { return new DataSource2<InstructionEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		/// <summary>returns the datasource to use in a Linq query when targeting RecipeCategoryDictionaryEntity instances in the database.</summary>
		public DataSource2<RecipeCategoryDictionaryEntity> RecipeCategoryDictionary {	get { return new DataSource2<RecipeCategoryDictionaryEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
