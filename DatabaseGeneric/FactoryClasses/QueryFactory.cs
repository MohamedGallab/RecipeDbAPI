...
namespace RecipeORM.FactoryClasses
{
	...
	public partial class QueryFactory : QueryFactoryBase2
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the RecipeCategoryDictionary entity</summary>
		public EntityQuery<RecipeCategoryDictionaryEntity> RecipeCategoryDictionary { get { return Create<RecipeCategoryDictionaryEntity>(); } }
