...
namespace RecipeDB.EntityClasses
{
	...
	
	{
		...
		public UserEntity(System.String username) : this(username, null)
		{
		}
		...
		/// <param name="username">PK value for User which data should be fetched into this User object</param>
		/// <param name="validator">The custom validator object for this UserEntity</param>
		public UserEntity(System.String username, IValidator validator)
		{
			InitClassEmpty(validator, null);
		...
		/// <remarks>Mapped on  table field: "User"."Username".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 255.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
